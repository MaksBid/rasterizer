...
import { multiplyMatrices3x3, isInFront, clipPoint, yawRotationMatrix, pitchRotationMatrix, getPointOnCanvas, pointToCamera, clipTriangle } from './math.js';
import { triangularPrism } from './exampleobjects.js';
    ...
    queue.forEach(item => {
        switch (item.type) {
            case 'point':
                ...
                break;
            case 'line':
                drawLine(item.screenCoordinates, item.color, 2);
                break;
            case 'triangle':

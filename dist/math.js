...
export function vectorSubtract3D(v1, v2) {
    return [
        v1[0] - v2[0],
        v1[1] - v2[1],
        v1[2] - v2[2]
...
export function multiplyMatrices3x3(m1, m2) {
    return [
        [
...
export function applyPerspectiveProjection(translatedPoint, displaySettings) {
